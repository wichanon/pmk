					...
					<div class="row">
						<div class="col-9 mx-auto">
							<div class="boxx">
								...
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<textarea type="text" class="form-control" id="detail" placeholder="...."></textarea>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<textarea type="text" class="form-control" id="author_detail" placeholder="...."></textarea>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row mt-2">
									<div class="col-9 mx-auto">
										<button class="btn_login mx-auto" onclick="create_article_technical()">บันทึก</button>
									</div>
								</div>
							</div>
						</div>
