					...
					<div class="row">
						<div class="col-9 mx-auto">
							<div class="boxx">
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<input type="text" class="form-control" id="name" placeholder="วิชา...." value="<?=$data['name'];?>">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row mt-2">
									<div class="col-9 mx-auto">
										<button class="btn_login mx-auto" onclick="edit_register_subjects(<?=$data['id']?>)">บันทึก</button>
									</div>
								</div>
							</div>
						</div>
