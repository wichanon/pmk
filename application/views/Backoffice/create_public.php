	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-10">
					<div class="row">
						<div class="col-6"><h3 class="title_page">เพิ่มประชาสัมพันธ์</h3></div>
					</div>
					<div class="row">
						<div class="col-9 mx-auto">
							<div class="boxx">
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										<label for="title">หัวข้อประชาสัมพันธ์</label>
								...
								<div class="row mt-2">
									<div class="col-9 mx-auto">
										<button class="btn_login mx-auto" onclick="create_public()" id="submit">บันทึก</button>
									</div>
								</div>
							</div>
						</div>
