	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-10">
					<div class="row">
						<div class="col-6"><h3 class="title_page">เพิ่มดาวน์โหลด</h3></div>
					</div>
					<div class="row">
						<div class="col-9 mx-auto">
							<div class="boxx">
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<input type="text" class="form-control" id="name" placeholder="เอกสาร...." value="<?=$data['name'];?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<input type="text" class="form-control" id="detail" placeholder="รายละเอียด...." value="<?=$data['detail'];?>">
										</div>
									</div>
								</div>
								<div class="row">
										...
										<div class="form-group">
											...
											<div class="custom-file">
												<input type="hidden" id="image_path">
											  	<input type="file" class="custom-file-input" id="image" accept="" onchange="uploadFile('image')">
								...
								<div class="row mt-2">
									<div class="col-9 mx-auto">
										<button class="btn_login mx-auto" onclick="edit_article_download(<?=$data['id']?>)">บันทึก</button>
									</div>
								</div>
							</div>
						</div>
