	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-10">
					<div class="row">
						<div class="col-6"><h3 class="title_page">แก้ไขแผนก</h3></div>
					</div>
					<div class="row">
						<div class="col-9 mx-auto">
							<div class="boxx">
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										<label for="title">ชื่อแผนก(ไทย)</label>
    										<input type="text" class="form-control" id="name" placeholder="ชื่อแผนก" value="<?=$data['name'];?>">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										<label for="detail">ชื่อแผนก(อังกฤษ)</label>
    										<input type="text" class="form-control" id="name_eng" placeholder="ชื่อแผนก" value="<?=$data['name_eng'];?>"></input>
										</div>
									</div>
								</div>
								<div class="row mt-3">
								...
								<div class="row mt-2">
									<div class="col-9 mx-auto">
										<button class="btn_login mx-auto" onclick="edit_department(<?=$data['id']?>)">บันทึก</button>
									</div>
								</div>
							</div>
						</div>
