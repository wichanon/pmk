	...
	<body>
		...
		<div class="container-fluid">
			<div class="row">
				...
				<div class="col-10">
					<div class="row">
						<div class="col-6"><h3 class="title_page">เพิ่มแผนก</h3></div>
					</div>
					<div class="row">
						<div class="col-9 mx-auto">
							<div class="boxx">
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<input type="text" class="form-control" id="title" placeholder="ชื่อแผนก">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-9 mx-auto">
										<div class="form-group">
    										...
    										<input type="text" class="form-control" id="detail" placeholder="ชื่อแผนก"></input>
										</div>
									</div>
								</div>
								<div class="row mt-3">
								...
								<div class="row mt-2">
									<div class="col-9 mx-auto">
										<button class="btn_login mx-auto" onclick="create_department()">บันทึก</button>
									</div>
								</div>
							</div>
						</div>
