    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-12 mb-4">
                ...
                <button type="button" class="btn btn-primary d-inline-block float-right">ตรวจสอบสถานะการลงทะเบียน</button>
            </div>
        </div>
    </div>
    ...
    <section class="pt-3 pb-5">
            <div class="container">
                <div class="row">
                    <div class="col-3">
                        <div class="card">
                            <img class="card-img-top" src="https://picsum.photos/150" alt="">
                            <div class="card-body">
                    ...
                    <div class="col-3">
                        <div class="card">
                            <img class="card-img-top" src="https://picsum.photos/550" alt="">
                            <div class="card-body">
                                <h4 class="card-title">Title</h4>
                                <p class="card-text">Text</p>
                            </div>
                    ...
                    <div class="col-3">
                        <div class="card">
                            <img class="card-img-top" src="https://picsum.photos/650" alt="">
                            <div class="card-body">
                                <h4 class="card-title">Title</h4>
                                <p class="card-text">Text</p>
                            </div>
                    ...
                    <div class="col-3">
                        <div class="card">
                            <img class="card-img-top" src="https://picsum.photos/355" alt="">
                            <div class="card-body">
                                <h4 class="card-title">Title</h4>
                                <p class="card-text">Text</p>
                            </div>
