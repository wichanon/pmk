    ...
    <div class="container pt-5">
        <div class="row">
            <div class="col-12 mb-4 d-flex align-items-center">
                <h1 class="title_text pl-3 d-inline-block">ตรวจสอบสถานะการลงทะเบียน</h1>
            </div>
            <div class="col-6 p-0">
                <div class="tab_search float-right p-3 pl-5 pr-5 selected">ตรวจสอบด้วยชื่อ</div>
            </div>
            <div class="col-6 p-0">
                <div class="tab_search float-left p-3 pl-5 pr-5">ตรวจสอบด้วยชื่อ</div>
            </div>
            <div class="col-12 pl-5 pr-5 mt-5">
                <div class="row pl-5 pr-5">
                    ...
                    <div class="col-12 ">
                            <button type="button" class="btn btn-primary float-right pl-5 pr-5 pt-2 pb-2">ค้นหา</button>
                        </div>
                </div>
